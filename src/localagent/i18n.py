...
_MESSAGES: dict[Lang, dict[str, str]] = {
    "zh": {
        ...
        "approval.mcp_reason": "MCP 外部工具 ({server}/{tool})",
        "approval.label_mcp": "调用 MCP 工具 {server}/{tool}",
    ...
    "en": {
        ...
        "approval.mcp_reason": "External MCP tool ({server}/{tool})",
        "approval.label_mcp": "call MCP tool {server}/{tool}",
